 ...
 * @author Dell
 */
public class FirstTicket extends TableForm {

    public FirstTicket() {
        initComponents();
        initBaseComponents(Table.FIRST_TICKET, TopLabel, ActionBtn);
    ...
    private void initComponents() {
        ...
        crewMemberCMB = new javax.swing.JComboBox<>();
        ...
        TopLabel.setText("First Class Ticket");
        ...
        jLabel31.setText("CrewMember:");
        jLabel31.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
        jLabel31.setOpaque(true);

        crewMemberCMB.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));
        crewMemberCMB.setBorder(new javax.swing.border.LineBorder(new java.awt.Color(0, 0, 0), 1, true));
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGap(18, 18, 18)
                                    .addComponent(crewMemberCMB, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                        .addGap(29, 29, 29))))
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(crewMemberCMB, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(59, 59, 59)
                .addComponent(ActionBtn)
    ...
    private javax.swing.JComboBox<String> crewMemberCMB;
    ...
    public AttributeCollection getAllAttributes() {
        ...
        String crewMemberSSN = crewMemberCMB.getSelectedItem().toString().trim();
        ...
        collection.add(new Attribute(Name.CREWMEMBER_SSN, crewMemberSSN, table));
    ...
    public Filters getBrowsingFilters() {
        ...
        if (!crewMemberSSN.isBlank()) {
            filters.addEqual(new Attribute(Name.CREWMEMBER_SSN, crewMemberSSN, table));
        }
        return filters;
    }
    ...
    public void populateFields(AttributeCollection toPopulateWith) {
        ...
        ComboBoxFactory.populateCrewMemberCMB(crewMemberCMB);
        ...
        String crewMemberSSN = toPopulateWith.getValue(new Attribute(Name.CREWMEMBER_SSN, table));

        numberCMB.setSelectedItem(number);
        seatField.setText(seat);
        loungeCMB.setSelectedItem(lounge);
        crewMemberCMB.setSelectedItem(crewMemberSSN);
    }
