...
public class Constraint {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Testing conPRIMARY with " + "P" + " " + conPRIMARY.equals("P"));
        System.out.println("Testing conUNIQUE with " + "U" + " " + conUNIQUE.equals("U"));
        System.out.println(
                "Testing conFOREIGN with " + "R_NAMEOFPRIMARYKEY" + " " + conFOREIGN.equals("R_NAMEOFPRIMARYKEY"));
        System.out.println("Testing conLESS_THAN with " + "C_X < 4" + " " + conLESS_THAN.equals("C_X < 4"));
        System.out.println("Testing conGREATER_THAN with " + "C_X > 4" + " " + conGREATER_THAN.equals("C_X > 4"));
        System.out.println("Testing conEQUAL with " + "C_X = 4" + " " + conEQUAL.equals("C_X = 4"));
        System.out.println("Testing conNOT_EQUAL with " + "C_X != 4" + " " + conNOT_EQUAL.equals("C_X != 4"));
        System.out.println("Testing conLESS_EQUAL with " + "C_X <= 4" + " " + conLESS_EQUAL.equals("C_X <= 4"));
        System.out.println("Testing conGREATER_EQUAL with " + "C_X >= 4" + " " + conGREATER_EQUAL.equals("C_X >= 4"));
        System.out
                .println("Testing conNOT_NULL with " + "C_X IS NOT NULL" + " " + conNOT_NULL.equals("C_X IS NOT NULL"));
        System.out.println("Testing conLIKE with " + "C_X LIKE WHATVER" + " " + conLIKE.equals("C_X LIKE WHATVER"));
        System.out.println(
                "Testing conBETWEEN with " + "C_X BETWEEN 5 AND 3" + " " + conBETWEEN.equals("C_X BETWEEN 5 AND 3"));
        System.out.println(
                "Testing conIN with " + "C_X IN ('A','B','C','D')" + " " + conIN.equals("C_X IN ('A','B','C','D')"));
        System.out.println("Testing conNUMBER with " + "NUMBER_5_2" + " " + conNUMBER.equals("NUMBER_5_2"));
        System.out.println("Testing conFLOAT with " + "FLOAT" + " " + conFLOAT.equals("FLOAT"));
        System.out.println("Testing conCHAR with " + "CHAR_3" + " " + conCHAR.equals("CHAR_3"));
        System.out.println("Testing conVARCHAR2 with " + "VARCHAR2_10" + " " + conVARCHAR2.equals("VARCHAR2_10"));
        System.out.println("Testing conDATE with " + "DATE" + " " + conDATE.equals("DATE"));
